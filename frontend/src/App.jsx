...
// Override via VITE_BRAND_NAME to reskin the dashboard for your own org —
// no code changes needed.
const BRAND_NAME = import.meta.env.VITE_BRAND_NAME || 'CreditSetu';
      ...
      <div className="min-h-screen bg-[#F7F8FA] text-gray-900 flex flex-col">
        ...
        <footer className="bg-white border-t border-gray-200 py-4 mt-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-xs text-gray-500">
            {BRAND_NAME} — this demo runs on synthetically generated data. See the{' '}
            <a
              href="https://github.com/adarshcod30/CreditSetu"
              target="_blank"
              rel="noreferrer"
            ...
            to integrate the underlying engine with your own data.
          </div>
        </footer>
      </div>
    </Router>
